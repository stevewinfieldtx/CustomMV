...
RUNWARE_API_URL = os.getenv('RUNWARE_API_URL', 'https://api.runware.ai/v1') # Corrected URL
...
def generate_images(prompts, num_images):
    ...
    for i in range(num_images):
        ...
        payload = [{"taskType": "imageInference", "model": "runware:100@1", "positivePrompt": current_prompt, "numberResults": 1, "outputFormat": "JPEG", "width": 896, "height": 1152, "steps": 12, "scheduler": "DPM++ 3M", "checkNSFW": True}]
