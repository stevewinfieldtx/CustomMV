...
def generate_images(prompts, num_images):
    ...
    for i in range(num_images):
        ...
        payload = [{"taskType": "imageInference", "model": "runware:100@1", "positivePrompt": current_prompt, "numberResults": 1, "outputFormat": "JPEG", "width": 896, "height": 1152, "steps": 12}]
...
def create_video_task(task_id, audio_url, original_request):
    ...
    try:
        ...
        cleanup_files = [local_audio_path, final_video_path] + images
